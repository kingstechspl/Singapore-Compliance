/**
 * Shared SOA HTML builder.
 * Called from both the Process Statement Of Accounts form and the Customer form.
 *
 * @param {string} statement_ref  - value shown as "Statement No." (doc name or customer name)
 * @param {object} r              - response from get_statements_of_account / get_customer_soa
 * @returns {string}              - full HTML ready for frappe.render_pdf
 */
window.build_soa_html = function (statement_ref, r) {
	let style = `
	<style>
	...
	<tbody>
		<tr>
			...
			<td class="left_dotted">
				<p class="address-sec" style="padding-left:10px;">Statement No.: ${statement_ref}</p>
